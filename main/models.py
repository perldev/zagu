...
class Banner(models.Model):
    ...
    is_pub = models.CharField(max_length=5, choices=TYPES, default='no', verbose_name=u"Опубликован")
...
class ProductionMenu(models.Model):
    ...
    url_item = models.CharField(max_length=255, blank=True, null=True, verbose_name=u"Url страницы")
...
class ProductionSimpleCatalog(models.Model):
    ...
    status = models.CharField(max_length=5, choices=TYPES, default='no', verbose_name=u"Опубликован")
...
class ProductionElecticSimple(models.Model):
    ...
    price = models.DecimalField(verbose_name=u"Цена", default=0, max_digits=18, decimal_places=2)
    currency = models.CharField(max_length=24, choices=CURRENCY, default='USD', verbose_name=u"Валюта")
    meta_keyword = models.CharField(max_length=255, blank=True)
    meta_description = models.CharField(max_length=255, blank=True)
    pub_date = models.DateTimeField('date published', auto_now=True, blank=True)
    ordering = models.IntegerField(verbose_name=u"Сортировка", default=0)
